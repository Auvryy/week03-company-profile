...
<section class="max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-12 items-center">
    ...
    <div class="border border-hairline p-8">
...
<section class="bg-white border-t border-hairline">
    <div class="max-w-6xl mx-auto px-6 py-24">
        <p class="font-mono text-xs uppercase tracking-widest text-muted mb-4">// 02 featured services</p>
        <h2 class="text-3xl font-bold mb-12">Where we protect you</h2>
